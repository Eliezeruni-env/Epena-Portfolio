...
export const heroTranslations = {
  es: {
    ...
    bio: "Desarrollador de software con experiencia probada en sistemas empresariales POS, ERP y dashboards gerenciales (.NET Onion, Angular, React, Express, PostgreSQL). Estudiante de Ingeniería en la Universidad del Caribe (UNICARIBE) y egresado del Instituto Tecnológico Fabio Amable Mota.",
  ...
  en: {
    title: "Eliezer Peña",
    role: "Full Stack Engineer & Solution Architect",
    bio: "Software Engineer with proven expertise building enterprise POS, ERP, and executive dashboard systems (.NET Onion Architecture, Angular, React, Express, PostgreSQL). Engineering student at Universidad del Caribe (UNICARIBE) and BTech graduate from Instituto Tecnológico Fabio Amable Mota.",
...
export const aboutTranslations = {
  es: {
    ...
    heading: "Sobre Mí",
    description: "Conoce mi trayectoria profesional como desarrollador de software en Nurbansoft, Precisa Group y la DETP, mi formación académica universitaria y técnica, y cómo mis competencias multidisciplinarias aportan valor a cada proyecto.",
    bioTag: "Ingeniería & Experiencia",
    bioTitle: "Quién Soy",
    bioP1: "Soy Eliezer Alberto Peña Zabala, desarrollador Full Stack radicado en República Dominicana. Mi trayectoria incluye el desarrollo de sistemas empresariales ERP y POS en Nurbansoft con arquitectura Onion de 4 capas (ASP.NET y Angular), dashboards operativos de call center y plataformas de Recursos Humanos en Precisa Group (React, Express, Supabase, PostgreSQL), así como sistemas educativos para la DETP (Laravel, Vue.js).",
    ...
    stat1Number: "2+ Años",
    stat1Label: "En Nurbansoft desarrollando ERP & POS (.NET & Angular)",
    stat2Number: "3+ Sistemas",
    stat2Label: "Desarrollados en Precisa Group (Collecta, Portal Gerencial, HRIS)",
    stat3Number: "Multi",
    ...
    languagesTitle: "Dominio de Idiomas & Lenguajes",
    ...
    langSqlTitle: "SQL Server (T-SQL)",
    langSqlLevel: "Avanzado",
    langSqlDesc: "Diseño y modelado relacional, optimización de consultas complejas, índices, transacciones ACID y persistencia de datos de alta escala.",
    ...
    outAreaIntro: "Mi experiencia laboral en call center de cobros y en operaciones comerciales de mostrador forjó competencias humanas e interpersonales invaluables:",
    pillarCallCenterTitle: "Agente de Call Center — Gestión de Cobros",
    pillarCallCenterDesc: "Gestión telefónica de carteras en mora, negociación asertiva de acuerdos y compromisos de pago, y manejo de objeciones bajo cumplimiento de metas de recuperación. Esta experiencia permitió comprender a fondo la operativa real de un call center, sus métricas y KPIs, inspirando el desarrollo del Portal Web Gerencial en Precisa Group y módulos financieros.",
    pillar1Title: "Visión Operativa & Arqueo de Caja",
    pillar1Desc: "Comprender de primera mano las necesidades operativas de un negocio (caja física, arqueos diarios de efectivo, inventarios) permitió concebir y diseñar la lógica de negocio de CuadreEnv.",
    pillar2Title: "Comunicación Asertiva & Negociación",
    pillar2Desc: "Habilidad probada en call center y mostrador para dialogar con usuarios y clientes, resolver conflictos y traducir requerimientos de negocio en software accesible y sin fricción.",
  ...
  en: {
    ...
    heading: "About Me",
    description: "Discover my engineering journey across Nurbansoft, Precisa Group, and the DETP, my higher university and technical degree background, language proficiencies, and how multidisciplinary experience drives quality across every system I build.",
    bioTag: "Engineering & Experience",
    bioTitle: "Who I Am",
    bioP1: "I am Eliezer Alberto Peña Zabala, a Full Stack Developer based in the Dominican Republic. My professional track record includes building enterprise ERP and POS systems at Nurbansoft using 4-tier Onion Architecture (ASP.NET and Angular), call center monitoring portals and Human Resources platforms at Precisa Group (React, Express, Supabase, PostgreSQL), and educational platforms for the DETP (Laravel, Vue.js).",
    ...
    stat1Number: "2+ Yrs",
    stat1Label: "At Nurbansoft developing ERP & POS (.NET & Angular)",
    stat2Number: "3+ Systems",
    stat2Label: "Engineered at Precisa Group (Collecta, Management Portal, HRIS)",
    stat3Number: "Multi",
    stat3Label: "Stack (.NET Onion, Angular, React, Express, PostgreSQL, Laravel, Vue)",
    ...
    languagesTitle: "Language & Technical Proficiencies",
    ...
    langSqlTitle: "SQL Server (T-SQL)",
    langSqlLevel: "Advanced",
    langSqlDesc: "Relational database modeling, complex query tuning, indexing strategies, ACID transactional consistency, and large-scale data storage.",
    ...
    outAreaIntro: "My professional experience as a collections call center agent and in commercial retail operations cultivated vital human and business competencies:",
    pillarCallCenterTitle: "Call Center Agent — Debt Collections & Recovery",
    pillarCallCenterDesc: "Outbound and inbound customer negotiation for delinquent accounts, payment plan agreements, and dispute resolution under demanding recovery targets. This operational field experience provided first-hand knowledge of call center workflows and metrics, directly inspiring the executive KPI portal for Precisa Group and financial reconciliation engines.",
    pillar1Title: "Retail Cash & Drawer Reconciliations",
    pillar1Desc: "Understanding the everyday reality of retail staff (cash transactions, physical currency drawer balancing, inventory) directly inspired the financial business logic of CuadreEnv.",
    pillar2Title: "Assertive Communication & Negotiation",
    pillar2Desc: "Proven ability honed in call center negotiations and customer-facing roles to bridge communication gaps and translate business constraints into frictionless, accessible software.",
...
export const projectsDataI18n: ProjectItemI18n[] = [
  ...
  },
  {
    ...
    role: { es: "Junior Software Developer (Jun 2023 - May 2025 · 2 yrs)", en: "Junior Software Developer (Jun 2023 - May 2025 · 2 yrs)" },
    overview: {
  ...
  },
  {
    ...
    role: { es: "Trainee Software Developer (Jan 2023 - Jul 2023 · 7 mos)", en: "Trainee Software Developer (Jan 2023 - Jul 2023 · 7 mos)" },
    overview: {
...
export const timelineDataI18n: TimelineEntryI18n[] = [
  {
    id: "nurbansoft-job",
    type: "tech",
    date: { es: "Jun 2023 - May 2025 · 2 años", en: "Jun 2023 - May 2025 · 2 yrs" },
    title: {
  ...
  },
  {
    id: "detp-job",
    type: "tech",
    date: { es: "Ene 2023 - Jul 2023 · 7 meses", en: "Jan 2023 - Jul 2023 · 7 mos" },
    title: {
  ...
  },
  {
    ...
    type: "other",
    date: { es: "Experiencia Formativa", en: "Formative Experience" },
    title: {
    ...
    bullets: {
      es: [
        ...
        "Experiencia operativa directa que permitió comprender a fondo la dinámica de los agentes de call center, KPIs y flujos de cobranza, aplicada posteriormente al desarrollar el Portal Gerencial en Precisa Group y módulos de CuadreEnv.",
      ],
      en: [
        ...
        "Direct operational field experience providing deep understanding of call center KPIs, agent presence, and payment reconciliation—later applied directly in software solutions for Precisa Group and CuadreEnv.",
      ],
    },
  ...
  },
  {
    ...
    date: { es: "Experiencia Formativa", en: "Formative Experience" },
    title: {
      es: "Supervisor de Operaciones & Arqueo de Caja",
      en: "Operations & Cash Drawer Supervisor",
    },
    subtitle: {
      es: "Sector Comercial & Retail en Mostrador",
      en: "Commercial & Retail Operations",
    },
    location: {
      es: "Santo Domingo, Rep. Dom.",
      en: "Santo Domingo, Dominican Republic",
    ...
    description: {
      es: "Responsable directo de apertura/cierre de turnos de caja, conciliación física de efectivo, arqueos diarios y control de inventario en tienda.",
      en: "Directly responsible for retail cash drawer opening/closing, physical currency balancing, daily reconciliations, and retail inventory.",
    },
    bullets: {
      es: [
        "Gestión de cuadres físicos diarios de caja, detección de discrepancias y resolución contable en tiempo real.",
        "Liderazgo de personal de mostrador, capacitación en velocidad de cobro y atención al cliente.",
        "Esta vivencia directa fue el catalizador para diseñar las reglas de negocio y automatizaciones del software CuadreEnv.",
      ],
      en: [
        "Led daily physical cash reconciliations, resolved drawer discrepancies in real time, and audited daily sales receipts.",
        "Supervised front-desk cashier staff, streamlining checkout velocity and customer satisfaction.",
        "This firsthand operational experience directly catalyzed the business rules and design of CuadreEnv.",
      ],
    },
    skills: ["Arqueo de Caja", "Control de Efectivo", "Resolución de Discrepancias", "Liderazgo de Equipo"],
    icon: faStore,
    iconBg: "#10b981",
  },
  {
    ...
    date: { es: "Experiencia Formativa", en: "Formative Experience" },
    title: {
      es: "Atención al Cliente & Soporte Operativo",
      en: "Customer Support & Operations Specialist",
    },
    subtitle: {
      es: "Servicio al Cliente & Operaciones",
    ...
    description: {
      es: "Atención directa a usuarios y clientes, canalización y resolución ágil de reclamos bajo entornos de alta exigencia.",
      en: "Direct customer and user assistance, rapid conflict resolution, and operational workflow coordination under tight turnaround times.",
    },
    bullets: {
      es: [
        "Desarrollo de alta tolerancia a la presión, empatía profunda con los problemas de los usuarios y escucha activa.",
        "Optimización de tiempos de respuesta en mostrador y gestión de procesos administrativos de servicio.",
        "Habilidades transferibles aplicadas hoy en día para diseñar UX intuitiva y libre de fricción técnica.",
      ],
      en: [
        "Cultivated high emotional intelligence, deep user empathy, and crisis mitigation skills under high volume.",
        "Reduced front-desk wait times and expedited internal operational ticketing.",
        "Transferable soft skills applied today to design frictionless, human-centric software UX.",
      ],
    },
    skills: ["Comunicación Asertiva", "Manejo de Crisis", "Orientación al Usuario", "Empatía"],
    icon: faHeadset,
    iconBg: "#059669",
  },
];
...
export const cvTranslations = {
  es: {
    ...
    profileText: "Desarrollador de Software Full Stack con más de 2 años de experiencia profesional construyendo sistemas empresariales de misión crítica (ERP, POS, portales gerenciales y plataformas de Recursos Humanos). Especialista en ASP.NET Web API aplicando Arquitectura Onion de 4 capas, frontend modular en Angular y React, y persistencia en SQL Server y PostgreSQL. Experiencia comprobada en Nurbansoft, Precisa Group y la DETP desarrollando APIs RESTful seguras con autenticación y control de accesos RBAC.",
    ...
    btechInst: "Instituto Tecnológico Fabio Amable Mota — Ago 2023 – May 2025",
    ...
    langSql: "SQL Server (T-SQL): Avanzado (Modelado Relacional, Procedimientos, Transacciones ACID)",
  ...
  en: {
    ...
    profileText: "Full Stack Software Developer with 2+ years of professional experience building mission-critical enterprise systems (ERP, POS, management portals, and HRIS platforms). Specialist in ASP.NET Web API applying 4-tier Onion Architecture, feature-based Angular and React frontends, and relational persistence on SQL Server and PostgreSQL. Proven track record across Nurbansoft, Precisa Group, and the DETP engineering secure RESTful APIs with RBAC access control.",
    ...
    btechInst: "Instituto Tecnológico Fabio Amable Mota — Aug 2023 – May 2025",
    ...
    langSql: "SQL Server (T-SQL): Advanced (Relational Schema Design, Stored Procedures, ACID Transactions)",
